        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, i) => (
              ...
              >
                <Link href={service.link} className="group block relative overflow-hidden aspect-[16/10]">
                  <Image
          src={service.image}
          alt={service.alt}
          fill
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {destinations.map((dest, i) => (
              ...
              >
                <Link href="/destinations" className="group block relative overflow-hidden aspect-[3/4]">
                  <Image
          src={dest.image}
          alt={dest.alt}
          fill
