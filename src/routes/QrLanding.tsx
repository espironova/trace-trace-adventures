    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-primary text-primary-foreground border-b border-primary-foreground/10">
        <div className="px-4 py-3 flex items-center justify-between max-w-3xl mx-auto">
          <Link href="/" className="flex items-center gap-2">
            <Image
          src={logo}
          alt="Track & Trace Adventures"
          width={180}
          height={64}
          className="h-9 w-auto w-auto"
        />
      ...
      <section className="relative">
        <div className="absolute inset-0">
          <Image
          src={heroImg}
          alt="Track & Trace Adventures safari fleet"
          fill
      ...
      <section className="py-12 bg-background">
        <div className="px-4 max-w-3xl mx-auto">
          ...
          width={180}
          height={64}
          className="h-28 w-44 object-cover flex-shrink-0 snap-start border border-border w-auto"
        />
            ))}
          </div>
        </div>
