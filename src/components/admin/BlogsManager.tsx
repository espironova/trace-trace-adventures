      ...
      <div className="bg-card border border-border p-6 rounded-md space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2 flex items-center gap-4">
            {form.image_url ? <img src={form.image_url} alt="" className="w-32 h-20 object-cover rounded" /> : null}
      ...
      <div className="space-y-3">
        ...
        {items.map(b => (
          <div key={b.id} className="flex items-center gap-4 bg-card border border-border p-3 rounded">
            {b.image_url && <img src={b.image_url} alt={b.alt} className="w-20 h-14 object-cover rounded" />}
